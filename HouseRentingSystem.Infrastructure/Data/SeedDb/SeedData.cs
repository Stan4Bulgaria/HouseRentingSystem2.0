...
namespace HouseRentingSystem2._0.Infrastructure.Data.SeedDb
{
    ...
    {
        public IdentityUser AgentUser { get; private set; }
        public IdentityUser GuestUser { get; private set; }
        public Agent Agent { get; private set; }

        public Category CottageCategory { get; private set; }
        public Category SingleCategory { get; private set; }
        public Category DuplexCategory { get; private set; }

        public House FirstHouse { get; private set; }
        public House SecondHouse { get; private set; }
        public House ThirdHouse { get; private set; }
        public SeedData()
        {
            SeedUsers();
            SeedAgent();
